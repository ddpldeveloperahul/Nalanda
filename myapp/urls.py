...
urlpatterns = [
    ...
    path('api/inspections/schedule/', views.ScheduleFieldInspectionAPIView.as_view(), name='schedule-field-inspection'),
    path('api/inspections/schedule/<str:pk_or_code>/', views.FieldInspectionDetailAPIView.as_view(), name='schedule-field-inspection-detail'),
    path('api/inspections/schedule/<str:pk_or_code>/cancel/', views.FieldInspectionCancelAPIView.as_view(), name='schedule-field-inspection-cancel'),
    path('api/inspections/schedule/<str:pk_or_code>/postpone/', views.FieldInspectionPostponeAPIView.as_view(), name='schedule-field-inspection-postpone'),
    path('api/inspections/schedule/<str:pk_or_code>/complete/', views.FieldInspectionCompleteAPIView.as_view(), name='schedule-field-inspection-complete'),
    path('api/interventions/propose/', views.ProposeInterventionAPIView.as_view(), name='propose-intervention'),
    path('api/interventions/propose/<int:pk>/', views.InterventionProposalDetailAPIView.as_view(), name='propose-intervention-detail'),
    path('api/interventions/propose/<int:pk>/<str:action_type>/', views.InterventionProposalStatusActionAPIView.as_view(), name='propose-intervention-status-action'),
    path('api/propose-intervention/', views.ProposeInterventionAPIView.as_view(), name='propose-intervention-alias'),
    path('api/propose-intervention/<int:pk>/', views.InterventionProposalDetailAPIView.as_view(), name='propose-intervention-detail-alias'),
    path('api/propose-intervention/<int:pk>/<str:action_type>/', views.InterventionProposalStatusActionAPIView.as_view(), name='propose-intervention-status-action-alias'),
